...
"templateMessage": {"hydratedTemplate": {...empat.message,"hydratedContentText": dua,"hydratedFooterText": tiga,"hydratedButtons": [
{"urlButton": {"displayText": "SOURCE CODE","url": "https://m.youtube.com/channel/UCEDb6SkiPU0theI8J_WEZZA"}},
{"urlButton": {"displayText": "OWNER","url": "https://wa.me/"+ nomerowner}},
...
✄ Membatasi mobilitas
┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅`
await sendMenu(from, menu, "BOT WHATSAPP BY VANZZ OFC", await nayla.sendnew(from, {video: {url: "./media/video/menu.mp4", caption: menu}, gifPlayback: true}))
break
case 'menu':
...
await sendMenuu(from, menuu, "BOT WHATSAPP BY VANZZ OFC", await nayla.sendnew(from, {video: {url: "./media/video/menuu.mp4", caption: menuu}, gifPlayback: true}))
break
case 'desk':
replyy(`┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅
✄ *PERATURAN*
